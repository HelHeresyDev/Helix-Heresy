(function attachHelixDeathRowCustody(root, factory) {
  ...
  const STATUSES = Object.freeze(["active", "executionProcessDue", "resentencingRequired", "retrialRequired", "releaseOrdered", "transferred", "escaped", "released", "deceased"]);
  ...
  function activeStay(value) { return normalizeState(value).stays.find((stay) => ["active", "executionProcessDue", "resentencingRequired", "retrialRequired", "releaseOrdered"].includes(stay.status)) || null; }
