...
1. Climate, Hydrology, and Biomes
2. Geology, Arcane Geography, Natural Hazards, and Resources
...
Build the next deterministic physical-world layer from the saved generation-version-three relief model. Generate latitude and elevation temperatures, prevailing circulation, ocean influence, rain shadows, precipitation, snow and ice tendencies, drainage direction, watersheds, lakes, major rivers, wetlands, and coherent terrestrial and marine biomes. Rivers must follow valid downhill graph paths or explicitly modeled basin overflow, and all propagation must cross the renderer's longitude seam normally. Add useful Climate, Hydrology, and Biome globe overlays and inspector fields. Keep this physical layer independent of World Theme, compact in canonical saves, and suitable for later settlement, creature ecology, travel, and local-map inputs.
