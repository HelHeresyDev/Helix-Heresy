...
1. City-Specific Law Codes and Punishment Policy
2. Cross-City Recognition, Jurisdiction, and Extradition
3. Religions, Gods, Churches, and Divine Competition
4. Commercial, Research, Military, and Internet Networks
5. Satellite Settlements, Local Logistics, and Evacuation Networks
6. Historical World Simulation and Crisis Coalitions
...
- The current generator preserves causal layers: globe topology and surface, relief, climate, hydrology, biomes, geology, natural and magical hazards, arcane geography, hidden resources and public prospects, fortified cities, strategic intercity corridors, sovereign city polities, beast ecology, and city governments with separate public directories.
...
Design and implement the substantive and procedural law of each independent city. Consume its saved charter, courts, prosecution, civil watch, jail, corrections, governing form, civic priorities, logistical pressures, and public beast-risk context. Generate stable semantic offense families, elements, burdens, defenses, enforcement policies, public attitudes, sentencing ranges, and available punishments without treating World Theme as an automatic cruelty or competence score. Preserve jail as temporary pretrial custody and prison as post-conviction punishment. Cities may use finite imprisonment, fines, restrictions, restitution, penal service, Penal Flight, or public execution according to their own saved policy, but should not default to life imprisonment in overcrowded refuges. Produce a public code projection and separate non-public enforcement priorities that later investigation, trial, sentencing, and custody systems can consume.

Do not modify files until the design has been discussed and the developer explicitly approves implementation.

## 2. Cross-City Recognition, Jurisdiction, and Extradition

Design and implement how independent city jurisdictions recognize identities, judgments, warrants, fugitives, corporations, property claims, and custody requests from one another. Begin from the saved city-only jurisdiction rules: cores and controlled approaches have continuous local jurisdiction; corridors require a controlled facility or convoy, or an explicit agreement; wilderness has no ordinary sovereign jurisdiction; internet effects do not grant remote enforcement power. Model sparse standing agreements and case-specific cooperation, refusal, asylum, extradition, transit custody, evidence transfer, and diplomatic consequences without creating national law, universal recognition, automatic warrant reach, or a superior court. Integrate through stable semantic contracts so existing investigation and legal systems can later select the correct city's law and physical actors after a run receives a world location.

Do not modify files until the design has been discussed and the developer explicitly approves implementation.

## 3. Religions, Gods, Churches, and Divine Competition

Design and implement gods, religious traditions, churches, cults, divine or arcane claims, holy sites, schisms, rivalries, and city-specific religious standing. Religious networks may span many independent cities through internet communication and local branches, but no church automatically owns a city or functions as a world state. Bind religious pressure, protection, doctrine, and institutional access to stable semantic roles that later investigation, law, resurrection, and campaign systems can consume.
