...
1. Religious Institution History
2. Non-State Network History
...
Advance human-known faith institutions only after playable-year settlement and route state establish which cities, populations, facilities, and physical connections still exist. Date every institutional branch at or after its city's foundation and treat existing generated standings, adherent bands, branch forms, capacities, roles, and integrity as founding baselines rather than unexplained playable-year facts. Consume divine, ecological-crisis, political, civic-institutional, and settlement history to retain causal branch founding, destruction, displacement, reestablishment, sponsorship, proscription, misconduct, divine censure, and capacity or standing changes.

An actively communicating god prevents same-god doctrinal heresy from becoming a valid split. A branch may disobey, conceal, or reject authenticated instruction, but it becomes censured or estranged rather than an equally confirmed faith. Genuine divine silence, descent, disappearance, or death may permit distinct unconfirmed successor traditions. Reascension or another authenticated return lets the god affirm or reject successor claims; rejected organizations may persist socially but remain explicitly unconfirmed. No successor automatically inherits divine confirmation, holy-site custody, or the original faith's identity.

Keep canonical divine truth, authenticated statements, local branch condition, city standing, institutional claims, hidden integrity, concealed misconduct, private divine attention, and covert sponsorship separate. Public history may expose authenticated divine judgments, visible branch changes, declared standing, and observable condition without revealing unsupported gods, exact hidden integrity, private attention, or undiscovered influence. Every retained change must have stable participants, a valid city or physical site, prerequisites, a saved cause, a bounded consequence, and a knowledge-safe public account.

Do not modify files until the design has been discussed and the developer explicitly approves implementation.

## 2. Non-State Network History

Advance major commercial, research, military, transport, media, black-market, and standards networks only after playable-year settlement and route state and religious institution history exist. Give every network a causal founding year, origin city, and required civilizational capabilities. Treat existing network identities, city standings, branch forms, affiliates, advertised capacities, hidden integrity, private priorities, and covert cells as founding baselines to be advanced through ecological crises, political and civic history, settlement loss, religious-institutional interaction, and capability change.

Track strategically significant public and covert branch founding, loss, relocation, sponsorship, proscription, collaboration, rivalry, institutional conflict, and collapse. Physical relocation requires feasible transport at the historical moment; internet communication cannot move personnel, equipment, or cargo. A network that loses every viable branch may become dormant or defunct, and no generated network is guaranteed to survive. A black-market presence may remain covert after proscription while public records show only supported suspicion. Network-city standing, public branch presence, covert presence, actual capacity, and integrity must remain distinct facts.

No network gains sovereignty, occupation authority, automatic enforcement power, or guaranteed long-range delivery. Public history may expose declared affiliations, dated public branches, standing changes, visible service failures, acknowledged collaboration or rivalry, and confidence while withholding covert cells, shell ownership, private priorities, hidden influence, exact capacity, and undiscovered misconduct. Every retained change must have stable participants, location, prerequisites, a saved cause, bounded consequences, and a knowledge-safe public account.
