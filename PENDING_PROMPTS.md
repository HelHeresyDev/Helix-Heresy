...
1. Legal Policy, Enforcement, and Public Attitude History
...
- The current generator preserves causal layers: globe topology and surface, relief, climate, hydrology, biomes, geology, natural and magical hazards, arcane geography, hidden resources and public prospects, compact pristine beast ecology, named pre-urban peoples and aggregate human population groups, population-backed pre-civic canonical divinity, human religious knowledge, semantic confirmed-faith identities and causally placed holy sites, the Year 0 first city and bounded rival divine origin attempts, authoritative origin founders and disconnected support components, broad civilizational capability eras with causal institutions and uneven physical adoption, fortified cities, strategic intercity corridors, sovereign city polities, separately derived playable-year beast ecology, city governments, city law codes, directional cross-city recognition, later human-known faith networks and city religious standing, commercial, research, military, transport, media, black-market, and standards networks, city founding purposes and powerful founders, joint route strongholds, dependent satellites, local logistics, evacuation plans, bounded divine conflict, descent, death, reascension, ascension, remains, and religious succession, bounded ecological-crisis history with temporary coalitions and physical consequences, sovereign-authority succession plus physically feasible intercity campaign, tribute, puppet, occupation, revolt, and displaced-claim history, and institution-specific civic capacity, independence, damage, capture, occupation direction, and displaced-charter history with separate public directories.
...
Advance each city's legal policies, enforcement priorities, procedural capacity, and public attitudes through the already generated physical, crisis, sovereign-authority, conflict, and civic-institutional history. Preserve the static semantic offense catalog while allowing explicit saved amendments to city-specific legal status, authorization, procedure, and sentencing policy. Keep recognized local law distinct from temporary occupation directives and actual enforcement practice.

Public attitudes must remain bounded aggregate pressures rather than a unanimous population mind or an automatic change to law. Enforcement policy may prioritize supported violations but can never infer guilt, change offense elements, fabricate evidence, or lower the published proof standard. Every retained amendment or shift must consume a saved cause, name the responsible authority or institution when strategically important, and produce an explicit playable-year legal, enforcement, procedural, or public-attitude fact with a separate knowledge-safe account.
...
An actively communicating god prevents same-god doctrinal heresy from becoming a valid historical split; misconduct, disobedience, concealment, succession during divine silence, and rivalry over resources remain possible. Keep canonical truth, local institutional condition, public claims, and covert influence separate. Every retained change must have stable participants, location, prerequisites, cause, saved consequence, and a knowledge-safe public account.
