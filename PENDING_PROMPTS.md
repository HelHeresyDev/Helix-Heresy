...
1. Sprite Asset Manifest and Loading Pipeline
2. Sprite Anchors, Orientation, and Multi-Tile Scaling
3. Render Layers, Occlusion, and Draw Order
4. Actor Facing, Pose, and Activity States
5. Animation Clock and Movement Interpolation
6. Player Knowledge, Fog, and Last-Known Visuals
7. Lighting, Environmental Tinting, and Visibility
8. Map Effects, Hazards, and Status Indicators
9. Glyph Fallback and Accessibility Modes
10. Large-Population Rendering Benchmark and Culling
11. Automated Visual Regression and Renderer-Parity Tests
