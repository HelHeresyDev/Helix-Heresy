...
- `warrant-executions.js` - Renderer-independent frozen warrant scope, service windows, search targets, exact seizures, custody transitions, obstruction, immutable returns, and deferred raid warrants.
- `site-visits.js` - Renderer-independent visit schedules, visitor identities, mandates, agendas, access requests, route observations, local examination progress, findings, obstruction records, and completion summaries.
