...
- `prison-break.js` - Renderer-independent concrete prison-break facts and assets, named accomplices, frozen collar strategies and sentence remainder, physical security stages, deterministic staff-exposure detection, causal capture, fugitive pursuit, collar removal, and watched-return records.
