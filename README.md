...
- Data-driven, versioned starting scenarios that materialize site blueprints, physical loadouts, spawn state, identity, and liabilities into authoritative saves, with Chemistry Front as the normal start and an underground-only Debug start.
