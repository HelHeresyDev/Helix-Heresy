...
- High-severity law-enforcement warrants now authorize deterministic named four-officer raids with saved objectives, scope, roles, equipment, communication, force causes, barrier outcomes, seizures, and history. Officers enter and search through ordinary physical movement, perception, doors, and structural damage; concealed underground areas remain unknown without a physical sighting. Surrender, restraint, extraction, booking, site escape, unsuccessful withdrawal, resistance, and death are separate outcomes. Booking moves the scientist into a physical municipal holding cell while the laboratory simulation continues; arrest never ends the run, and the initial difficult self-escape route requires repeated security study before producing fugitive evidence.
