...
- `prison-custody.js` - Renderer-independent finite prison intake, sentence service, deterministic facility population, daily routines, assignments and prison wages, relationships, discipline, delayed communications, knowledge boundaries, and release-due events.
