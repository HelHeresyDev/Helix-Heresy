...
- High-severity law-enforcement warrants authorize deterministic named four-officer raids with saved objectives, scope, roles, equipment, communication, force causes, barrier outcomes, seizures, and history. Booking now leads into a compact physical temporary jail with intake and neighboring cells, secure corridor, monitored holographic call room, legal room, guard station, exercise room, transfer bay, named custody staff, saved routines, an armored transport record, and physical communication escorts. A jail-issued warded collar occupies the scientist's Neck slot and completely suppresses magic until physically disabled. Laboratory knowledge freezes at booking and updates only through delayed explicit reports; five distinct non-repeatable security observations support the provisional escape. Arrest never ends the run.
