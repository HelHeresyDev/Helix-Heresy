...
- `warrant-executions.js` - Renderer-independent frozen warrant scope, service windows, search targets, exact seizures, custody transitions, obstruction, target-linked forced entry, late compliance, narrow physical expansion, violence outcomes, immutable original and supplemental returns, and deferred raid warrants.
