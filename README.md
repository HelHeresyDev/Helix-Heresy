...
- Data-driven, versioned starting scenarios that materialize site blueprints, physical loadouts, spawn state, identity, and liabilities into authoritative saves, with the divided Chemistry Front as the normal start and an underground-only Debug start. Existing version-one Chemistry Front saves retain their recorded provenance and topology.
